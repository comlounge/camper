...
class SocialEditForm(BaseForm):
    ...
    gplus               = TextField(T("Google Plus URL"), [validators.Optional(), validators.Length(max=100), validators.URL()], description=T("URL of the Google Plus Profile"))
    facebook            = TextField(T("Facebook URL"), [validators.Optional(), validators.Length(max=100), validators.URL()], description=T("URL of the Facebook Page"))
    homepage            = TextField(T("Homepage URL"), [validators.Optional(), validators.Length(max=500), validators.URL()], description=T("link to the homepage of this barcamp in case one exists."))
