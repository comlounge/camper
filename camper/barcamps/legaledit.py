...
class LegalEditForm(BaseForm):
    ...
    imprint             = WYSIWYGField(T("Imprint"), [validators.Required(), validators.Length(max=2000)], description=T("Please describe in detail who is responsible for this barcamp. This is mandatory for paid barcamps."))
