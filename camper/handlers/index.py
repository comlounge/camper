...
class IndexView(BaseHandler):
    ...
    def get(self):
        ...
        my_barcamps = [BarcampView(barcamp, self) for barcamp in new_barcamps]
        my_barcamps = [b  for b in new_barcamps if b.barcamp.public or b.is_admin or self.is_main_admin]
        return self.render( 
