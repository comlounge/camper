;(function(exports) {
  ...
  var calendarGenerators = {
    google: function(event) {
      ...
      return '<li><a target="_blank" href="' +
        href + '"><i class="fa fa-google"></i> Google Calendar</a>';
    },
    ...
    yahoo: function(event) {
      ...
      return '<li><a target="_blank" href="' +
        href + '"><i class="fa fa-yahoo"></i> Yahoo! Calendar</a>';
    },
    ...
    ics: function(event, eClass, calendarName) {
      ...
      return '<li><a target="_blank" href="' +
        href + '"><i class="fa '+eClass+'"></i> ' + calendarName + ' Calendar</a>';
    },
  ...
  var generateMarkup = function(calendars, clazz, calendarId) {
    ...
    Object.keys(calendars).forEach(function(services) {
        listElem.innerHTML += calendars[services];
    });
